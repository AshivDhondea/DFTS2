...
deep_model_name = 'densenet121'#'efficientnetb0'
normalized = True
reshapeDims = [224,224]
splitLayer = 'pool2_conv'#'block2b_add'
quant1 = 8
rowsPerPacket = 8
...
results_dir = os.path.join('altec_yml',deep_model_name,splitLayer)
os.makedirs(results_dir,exist_ok=True)

filename = os.path.join('altec_yml','altec_template.yml')
...
yml_dict['ErrorConcealment']['ALTeC']['include'] = True
