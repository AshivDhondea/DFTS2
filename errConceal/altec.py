...
The code has been modified to run with DFTS packets (multiple consecutive rows
of features per packet whereas the original ALTeC assumes a packet consists of
a single row of feature tensor data.)
