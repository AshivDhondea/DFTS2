...
#from tensor_completion import silrtc
...
# """
# def TC_Loader(tensor_completion):
#     chtype = list(tensor_completion.keys())[0]
#
#     if chtype == 0:
#         return 'noTensorCompletion'
#     elif chtype== 'SiLRTC':
#         return silrtc.Complete_Tensor
# """
