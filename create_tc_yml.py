...
Can be used for HaLRTC and SiLRTC
...
results_dir = os.path.join('silrtc_yml',deep_model_name,splitLayer)
os.makedirs(results_dir,exist_ok=True)

filename = os.path.join('silrtc_yml','tc_template.yml')
...
yml_dict['ErrorConcealment']['SiLRTC']['include'] = True
